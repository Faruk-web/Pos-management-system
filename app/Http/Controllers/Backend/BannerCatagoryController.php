...
class BannerCatagoryController extends Controller
{
    ...
    public function BennarView(){
        $ecom =Ecommerce_Name::all();
        $bennars_category =BannerCatagory::with('ecommerce')->get();
        return view('backend.bannerCatagory.banner_view',compact('bennars_category','ecom'));
    ...
    public function BennarStore(Request $request){
        $request->validate([
           ...
           BannerCatagory::insert([
                ...
                $notification = array(
                    'message' =>'Banner Catagory Created sucessfully',
                    'alert-type' =>'success'
                );
    ...
    // Banner Edit
        public function BennarEdit($admin,$id){
            ...
            // dd($bennars);
            return view('backend.bannerCatagory.banner_edit', compact('bennars','ecom'));
        } // end mathod
