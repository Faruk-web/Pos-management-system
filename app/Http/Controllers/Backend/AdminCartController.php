...
class AdminCartController extends Controller
{
    ...
    public function OrderConfirm(Request $request)
    {
        ...
        $agent_panel=AgentPanel::where('id',$orderdata->agent_id)->first();
         $commissionamount=floatval(($orderdata->totalAmount * $agent_panel->commission_given)/100);
        if($orderdata->agent_id !=null)
        {
            AgentCommission::insert([
                ...
                'total_sale_amount' => $orderdata->totalAmount,
    ...
    $user = new User();
        ...
        $user->agent_id = Auth::guard('admin')->user()->agent_id;
        $user->save();
