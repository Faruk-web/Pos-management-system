...
@endphp
            ...
            <div class="total">
                <table style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="text-align: right;">(+){{optional($order)->delivery_charge}}TK.</td>
                    </tr>
                    
                    @php
                        $deliveryChargewithamount = floatval($order->delivery_charge) + floatval($order->amount) ;
                        
                    @endphp

                    <tr>
                        <td style="text-align: right;">Net Amount:</td>
                        <td style="text-align: right;"> {{ $deliveryChargewithamount }}TK.</td>
                    </tr>
                    ...
                    <tr class="payableamount"  >
                        ...
                        <td style="text-align: right;border-top: 1px dotted grey;"> {{ $deliveryChargewithamount }}TK.</td>
                    </tr>
                    <tr class="TB">
            ...
            <div class="footer">
                ...
                <p class="text-center" style="text-align:center; margin: 3px;" >Share Your Opinion at <br> {{ optional($info)->email }}</p><br>
