                            ...
                            <div class="phoneContainer">
                                ...
                                <div class="phoneNumberContainer">
                                    ...
                                    <div class="number" id="number2">
                                        <input id="mobile_page" name="mobile" onclick="showText2()" type="tel" value="+88">
                                    </div>
                                </div>
                                <p style="color:red" class="hidePhoneText" id="hidePhoneText2">e.g. +01712345678</p>
                            </div>
                            ...
                            <div class="pinCodeButton">
                               <button>ENTER</button>
                                <div class="timer-inner d-flex align-items-center flex-column">
                                    <div>Time left = <span id="timerr"></span></div>
...
<script>
            ...
            function sentCodeInPhone2(){
                ...
                var text = document.getElementById("mobile_page").value;
                ...
                if(validPhn.test(text)){
                    ...
                    document.getElementById("hidePhoneText2").innerText = "Please enter a valid bangladeshi number. e.g. +8801612345678"
                }               
