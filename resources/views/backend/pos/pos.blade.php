        ...
        <div class="container-fluid">
            <div class="row mt-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 bg-white">
                    ...
                    <div class="table-wrapper pt-4" style="height:70%;width:auto;overflow:auto; margin-top:5px;">
                        {{-- <div class="scroller"> --}}
        ...
        <script>
            ...
            function Cartproduct() {
                $.ajax({
                    ...
                    success: function(data) {
                        console.log('sgehtgbgfvfggfgfgggfgfhgfghgfggfgfgb');
                        console.log('the data i want'+data);
