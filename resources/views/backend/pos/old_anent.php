        ...
        <div class="container-fluid">
            <div class="row mt-4">
                    ...
                    <div class="card">
                        <div class="row">
                            ...
                            <div class="col-xl-2 col-sm-12">
                                <button onclick="allOrders()" class="btn jfss-btn" style="margin-top: 20px;margin-left: 400px;">Hold
                                    Orders</button>
                                        ...
                                        <input type="hidden" id="vat" class="vat"  value="{{ Config::get('cart.tax') }}">
                                            <span class="input-group-text pointer input-grp-bg" data-bs-toggle="modal"
                                                data-bs-target="#customer-modal" title="New Customer?" style="margin-left: 271px; margin-top: -59px;  font-size: 38px;">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 bg-white">
                    ...
                    <div id="tableScroll" class="table-wrapper pt-4" style="height:70%;width:auto;overflow:auto; margin-top:5px;">
                        <table>
                            <thead>
                                <tr style="height: 56px;">
                                    <th>Image ggg</th>
                    ...
                    <div class="container modal-body">
                        <div class="row payment-body">
                            ...
                            <div class="col-md-3 text-end">
                                ...
                                <div>
                                    <span id="cash_quenty_tot_amt"> TK</span>
                                </div>
                                <div>
                                    <span id="cash_quenty_tot_dis">- TK</span>
                                </div>
                                <div>
                                    <span id="spesial_discount">-TK</span>
                                </div>
                                <div>
                                    <span id="cash_vat">+ TK</span>
                                </div>
                                <div>
                                    <span>00.00 TK</span>
                                </div>
    ...
    function loadProduct(pageID){
        ...
        .done(function(response){
            ...
            $.each(response.data,function(index,value){
                productInformation+=`
                    <tr onclick="AddProduct( ${value.id} )">
                                <td> <img
                                        src="/${value.product_thambnail ? value.product_thambnail : ''}"
                                        alt="" class="img-fluid table-img">

                                <td style="width: 150px;">${value.product_name }</td>
                                <td>${value.product_qty }</td>
                                <td>${value.unit }</td>
                                <td>&#2547 ${value.selling_price }</td>
                    </tr>
                `;
            });
