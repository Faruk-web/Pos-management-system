    ...
    <div class="container-fluid pt-5">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title pb-2">Edit Admin User here is te</h4>
                        <form method="post" action="{{ route('role.admin.user.update', config('fortify.guard')) }}"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="user-name" name="name" class="form-control"
                                                    value="{{ $adminuser->name }}" placeholder="User Name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="controls">
                                                <input type="number" id="phone" name="phone" class="form-control"
                                                    value="{{ $adminuser->phone }}" placeholder="Phone Number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="controls">
                                                <input type="email" id="email" name="email" class="form-control"
                                                    value="{{ $adminuser->email }}" placeholder="Email">
                                            </div>
                                        </div>

                                        <div>
                                            <img id="showImage" src="{{ url('upload/no_image.jpg') }}" alt="img"
                            ...
                            <div class="admin-access-container pt-4">
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_2" name="admin_dashboard" value="1" {{ $adminuser->brand ==
                                            1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_2" name="brand" value="1" {{ $adminuser->brand == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-success">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_3" name="category" value="1" {{ $adminuser->category == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-danger">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_4" name="product" value="1" {{ $adminuser->product == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-warning">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_5" name="slider" value="1" {{ $adminuser->slider == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-pink">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_6" name="cupons" value="1" {{ $adminuser->cupons == 1 ?
                                            'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_7" name="shipping" value="1" {{ $adminuser->shipping == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-success">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_9" name="setting" value="1" {{ $adminuser->setting == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-danger">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_10" name="returnorder" value="1" {{ $adminuser->returnorder
                                            == 1 ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-warning">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_11" name="review" value="1" {{ $adminuser->review == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-warning">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_17" name="pos" value="1" {{ $adminuser->pos == 1 ?
                                            'checked' : '' }}>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-check mb-2 form-check-primary">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_12" name="orders" value="1" {{ $adminuser->orders == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-success">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_13" name="stock" value="1" {{ $adminuser->stock == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-danger">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_14" name="reports" value="1" {{ $adminuser->reports == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-warning">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_15" name="alluser" value="1" {{ $adminuser->alluser == 1 ?
                                            'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2 form-check-danger">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_16" name="adminuserrole" value="1" {{
                                        ...
                                        <div class="form-check mb-2 form-check-danger">
                                            <input type="checkbox" class="form-check-input rounded-circle"
                                                id="checkbox_16" name="agent_add" value="1" {{ $adminuser->agent_add ==
                                            1 ? 'checked' : '' }}>
