                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <h6 class="total-user-nbr"><span class="badge badge-pill badge-danger" style="font-size: 15px;"> {{ count($users) }} </span></h6>
                        </div>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('role.all-users-show',[config('fortify.guard'),$user->id]) }}" class="btn btn-primary" title="View Data" id="view">
