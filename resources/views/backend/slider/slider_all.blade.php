            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="AddSliderForm">
                        @csrf
                        <div class="mb-3">
                            <label for="title" class="form-label">Ecommerce Name <b style="color:red; font-size:20px; font-weight:bold">*</b> </label>
                            <select name="ecom_name" class=" form-select form-control " required  
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="updateSliderForm">
                        ...
                        <div class="mb-3">
                            <label for="title" class="form-label">Ecommerce Name</label>
                            <select name="ecom_name" id="ecom" class=" form-select form-control ">
                                <option value="" selected="" disabled="">Select Ecommerce Name
                                </option>
                                @foreach($ecom as $ecoms)
                                <option value="{{ $ecoms->id }}">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data, function(key, data) {
                            ...
                            <td>${data.ecommerce.ecom_name}</td>
                            <td>${data.title}</td>
