        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="col-lg-6 col-12 paymentInfo">
                  <h4 class="header-title">Update Product List</h4>
                ...
                <div class="col-lg-6 col-12 d-lg-flex justify-content-lg-end">
                         ...
                         <table id="datatable-buttons" class=" table table-striped nowrap w-100 dataTable no-footer" role="grid"
                            ...
                            <thead>
                                <tr>
                                    <th>Product Update Date & Time</th>
                                   <th>Image</th>
                            ...
                            <tbody
                               ...
                               @foreach ($updateTrackingHistory as $history)
                                    <tr>
                                
                                    <td>{{optional($history->productName)->employee_date}}</td>
                                    
                                      <td> <img src="{{ asset($history->productName->product_thambnail) }}"style="width: 60px; height: 50px;"> </td>
