...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card mt-2">
            ...
            <!-- /.box-header -->
            <div class="card-body">
                <form method="POST" action="{{ route('role.bannerCategory.update',config('fortify.guard')) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <select name="ecom_id" class=" form-select form-control ">
                                ...
                                <option value="{{ $ecoms->id }}" {{ $ecoms->id == $bennars->ecom_id ? 'selected' :''
                                    }}>
                        ...
                        <div class="controls">
                            <input type="text" id=" banner_title" name="banner_title"
                                value="{{ $bennars->banner_title }}" class="form-control">
